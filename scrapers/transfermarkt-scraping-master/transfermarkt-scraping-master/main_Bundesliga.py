...
#https://www.transfermarkt.co.uk/wettbewerbe/europa/wettbewerbe
...
if __name__ == "__main__":
	...
	LeagueUrlDic =  { 'Ligue 1' :'https://www.transfermarkt.co.uk/ligue-1/startseite/wettbewerb/FR1' for league in Leagues}
	LeaguesData = []
	#for leagueName, leagueUrl in LeagueUrlDic:
		#print( "Scraping the %s..." %leagueName)
	LeaguesData.append( League( 'Ligue 1', 'https://www.transfermarkt.co.uk/ligue-1/startseite/wettbewerb/FR1', scraper))
	...
	df.to_csv("DataTransfermarkt2020Ligue1.csv", index=False)
